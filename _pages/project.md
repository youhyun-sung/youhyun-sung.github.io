...
<figure class="project-video">
  <video controls playsinline preload="metadata">
    <source src="/assets/videos/seeing-ambiguity-demo.MP4" type="video/mp4">
    Your browser does not support the video tag.
  </video>
</figure>
...
Sung, Y., Sung, M., Carbon, C., & Wallraven, C. (2026). *Does Spatial Ambiguity Contribute to Aesthetic Preference? Evidence from Op Art and Matched Control Stimuli.* Selected for oral presentation at the Visual Science of Art Conference (VSAC) 2026. Originally submitted as a poster.
